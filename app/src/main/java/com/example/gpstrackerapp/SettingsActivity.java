...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText nameEditText, phoneEditText, driverCarName,driverOrigin,driverDestination;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageView = findViewById(R.id.profile_image_drivers);

        nameEditText = findViewById(R.id.name_driver);
        phoneEditText = findViewById(R.id.Phone_driver);

        driverCarName = findViewById(R.id.Car_name_driver);

        driverOrigin=findViewById(R.id.origin_driver);
        driverDestination=findViewById(R.id.destination_driver);
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    startActivity(new Intent(SettingsActivity.this, UserLocationMainActivity.class));
                }
            }
        });
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        userMap.put("username", nameEditText.getText().toString());
                        ...
                        if (getType.equals("Drivers"))
                        {
                            ...
                            userMap.put("origin",driverOrigin.getText().toString());
                            userMap.put("destination",driverDestination.getText().toString());
                        }
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists()  &&  dataSnapshot.getChildrenCount() > 0)
                {
                    ...
                    if (getType.equals("Drivers"))
                    {
                        ...
                        driverOrigin.setText(origin);
                        driverDestination.setText(destination);
                    }
